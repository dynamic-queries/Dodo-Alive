function [x_list, t_list, alpha_phases, xi_values] = calculate_SLIP_single(x0, params)
...
alpha       = params(1);          %initial attack angle \in [0, 360]
...
t_phases{1} = [];                       %initialization needed for syntax
